defmodule FileSniffer do
  ...
  def verify(file_binary, extension) do
    handle_match(type_from_binary(file_binary), type_from_extension(extension))
  end

  defp handle_match(mime_type, mime_type), do: {:ok, mime_type}
  defp handle_match(_, _), do: {:error, "Warning, file format and file extension do not match."}
end
